...
### Project Purpose
To remove the actual AminoJS library implementation, allowing ProtoBuf to be the standard. This will reduce the total size of 
the impacted packages and also increase the Node version support since AminoJS was delaying this upgrade.

### Key Goals Of Project
- Remove the AminoJS library implementation.
- Integration testing.
- Unit testing.
#### Milestone
...
#### Issues  
**List**  
- [Issue 1  ](https://github.com/pokt-network/pocket-js/issues/401)
- [Issue 2  ](https://github.com/pokt-network/pocket-js/issues/402)
