...
### Project Purpose
JSON Schema will allow us to properly define a standard for the dispatch, relay, transaction, and RPC responses on pocket-js; Increases the visibility to detect problems between the raw responses of the network and the pocket-js response models and it opens the door for other languages to implement the schema on their side.

### Key Goals Of Project
- Replace existing RPC models with JSON Schema.
- Replace existing Relay models with JSON Schema.
- Integration testing.
- Unit testing.
#### Milestone
...
#### Issues  
**List**  
- [Issue 1  ](https://github.com/pokt-network/pocket-js/issues/405)
- [Issue 2  ](https://github.com/pokt-network/pocket-js/issues/406)
