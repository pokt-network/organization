### Project Title [Backwards Compatibility]  
### Leader  
[NAME: PABEL NUNEZ]  
### Date(s)  
20/01/2021  
...
### Project Purpose
The main objective is to assure that the developer can use AminoJS or Protobuf while the transition period is over for both testnet and production.
### Key Goals Of Project
- Assure backwards compatibility until transition ends. 
#### Milestone
...
- Validating that the Configuration parameter is changing to the encoding functions for AminoJS or Protobuf accordingly.
- Confirm the encoding to be AminoJS or Protobuf.
