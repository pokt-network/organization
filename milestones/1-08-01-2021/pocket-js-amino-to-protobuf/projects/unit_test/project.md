...
### Project Purpose
Create new and improve existing unit tests for the AminoJS to ProtoBuf implementation.
### Key Goals Of Project
- Assure transaction signing works for both AminoJS and ProtoBuf.
#### Milestone
...
- Validate each functionality linked to the transaction signing.
#### Issues  
**List**  
