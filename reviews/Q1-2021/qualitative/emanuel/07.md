...
Excellent. Always makes sure to test properly.
...
Gets right to work and is fast when supporting users in the community server.
...
Most active member in the community server.
...
Has many ideas and tries to find a way to implement them.
...
Always active and communicative. Asks many questions and answers them.
...
Emanuel is very active in all brainstorming sessions as well as every channel.
...
Emanuel has all the qualities to lead, plan and execute projects.
...
Pretty knowledgeable about everything. 
